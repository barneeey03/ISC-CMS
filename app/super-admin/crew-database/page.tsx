          ...
          <div className="flex-1 ml-64">
            ...
            <div className="bg-white border-b border-[#E0E8F0] p-6">
              ...
              <p className="text-[#80A0C0] mt-1">
                Access complete crew information and records
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-end">
                    <div className="w-full px-4 py-2.5 bg-[#E8F4F8] rounded-lg border border-[#B0D8E8]">
                      ...
                      <p className="text-2xl font-extrabold text-[#0080C0]">
                ...
                <div className="bg-white rounded-lg shadow-md p-12 text-center">
                  ...
                  <p className="text-[#80A0C0]">
                    {searchTerm
                      ...
                      : "No approved crew members in the database yet."}
                  </p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#002060] capitalize">
                            {crew.gender}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mb-4 pb-4 border-b border-[#E0E8F0]">
                        <p className="text-xs font-semibold text-[#80A0C0] mb-1">
                          Address
                        </p>
                        <p className="text-sm text-[#002060]">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="p-3 bg-[#E8F4F8] rounded-lg border border-[#B0D8E8]">
                          <p className="text-xs font-semibold text-[#0080C0] mb-1">
                            High School
                          </p>
                          <p className="text-sm text-[#002060]">
                            {crew.highSchool.schoolName || "Not provided"}
                            {crew.highSchool.yearGraduated &&
                              ` (${crew.highSchool.yearGraduated})`}
                          </p>
                        </div>
                        <div className="p-3 bg-[#E8F4F8] rounded-lg border border-[#B0D8E8]">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-[#80A0C0]">
                          Status
                        </span>
                        <span
